...
import com.google.gwt.http.client.Request.RequestImpl;
...
public class MyRequestBuilder extends RequestBuilder
{
	...
	public Request sendRequest(String requestData, RequestCallback callback) throws RequestException 
	{
	    ...
	    try {
		      request.getMyXMLHttpRequest().send(requestData);
	...
	public Request send(FormData formData, RequestCallback callback) throws RequestException 
	{
	    StringValidator.throwIfNull("callback", callback);
		MyRequest request = createXMLHttpRequest(callback);
//	    setHeaders(request.getMyXMLHttpRequest()); tu tega ne smem klicati, ker nastavi content-type na text, pri formDtaa pa browser sam nastavi multicofig. Potrebno 
		//pogruntati kkao v tem primeru samo drzge headers nastaviti. Morda tu z boolean, ki pove ali naj se default content-type izvede ali ne
	    try {
	  ...
	  private MyRequest createXMLHttpRequest(final RequestCallback callback) throws RequestException 
	  {
		    ...
		    {
		    	xmlHttpRequest.setResponseType(responseType.getResponseTypeString());
		    }
...
//	public static class MyResponse extends ResponseImpl
//	{
//		private MyXMLHttpRequest myXMLHttpRequest;
//		public MyResponse(XMLHttpRequest xmlHttpRequest) 
//		{
//			super(xmlHttpRequest);
//			this.myXMLHttpRequest = (MyXMLHttpRequest) xmlHttpRequest;
//		}
//
//		public String getJson() 
//		{
//			return myXMLHttpRequest.getResponseJson();
//		}
//		public Blob getBlob()
//		{
//			return myXMLHttpRequest.getResponseBlob();
//		}
//		
//	}
//	
//	public static class MyRequestImpl extends RequestImpl
//	{
//		private static  Logger logger = Logger.getLogger("MyRequestImpl");
//		public MyRequestImpl() 
//		{
//			logger.log(Level.INFO, "MyRequestImpl constructor invoked...");
//		}
//		@Override
//		Response createResponse(XMLHttpRequest xmlHttpRequest) 
//		{
//		      return new MyResponse(xmlHttpRequest);
//		}
//	}
}
