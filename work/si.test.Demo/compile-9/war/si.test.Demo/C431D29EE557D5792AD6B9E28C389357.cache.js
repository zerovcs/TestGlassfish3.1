...
_.onResponseReceived_0_g$ = function tde_g$(request_0_g$, response_0_g$){
  ...
  json_0_g$ = Xhe_g$($sc_g$(request_0_g$, 1654).getMyXMLHttpRequest_0_g$());
  jro_0_g$ = htc_g$(vde_g$(json_0_g$));
  zRc_g$(jro_0_g$.x + '   ' + jro_0_g$.y);
}
;
...
function vde_g$(obj_0_g$){
  ude_g$();
  return _sc_g$(obj_0_g$, 1);
}
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/si.test.Demo/C431D29EE557D5792AD6B9E28C389357_sourcemap.json 
